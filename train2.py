...
# Load the dataset with specific download configurations
# Set the path to the manually downloaded and extracted dataset
data_dir = 'C:/Users/Basel/datasets/oxford_flowers102'

# Function to use the manually downloaded dataset
def load_local_oxford_flowers102(data_dir):
    # Define the dataset builder
    builder = tfds.ImageFolder(data_dir)
    return builder.as_dataset(split=['train', 'test', 'validation'], as_supervised=True), builder.info

# Load the dataset from the local directory
dataset, info = load_local_oxford_flowers102(data_dir)
